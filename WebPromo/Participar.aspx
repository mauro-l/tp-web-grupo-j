<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Participar.aspx.cs" Inherits="WebPromo.Participar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
     ...
     <div class="col-6 g-3 mx-auto text-center py-4">
             ...
             <div class="mimodal-invisible"> 
                 <div class="card" style="width: 18rem;">
                     <div class="card-body">
                         ...
                         <asp:Button Text="volver" runat="server" CssClass="btn btn-secondary" ID="btnVolver" OnClick="btnVolver_Click" />
                         <asp:Button Text="cerrar" runat="server" CssClass="btn btn-primary" OnClick="Unnamed_Click" ID="Unnamed" />
                     </div>
                 </div>
             </div>
         </div>
         ...
         <div aria-describedby="helpBlock">
             <div class="col-auto">
                 <asp:Label ID="textoActivo" ClientIDMode="Static" runat="server" Text="Ingrese el codigo" CssClass="code-title"></asp:Label>
             </div>
